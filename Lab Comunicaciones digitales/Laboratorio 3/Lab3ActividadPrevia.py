...
class Lab3ActividadPrevia(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_1_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 3000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_add_const_vxx_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_multiply_xx_1_1, 1))
        self.connect((self.analog_sig_source_x_0_1_0, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.analog_sig_source_x_0_1_0_0, 0), (self.blocks_multiply_xx_1_1, 0))
